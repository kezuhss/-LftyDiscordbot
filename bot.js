...
if (settings.musicEnabled === "true") {
  ...
  client.YouTube = new YouTube("AIzaSyCbJoYCyCkJdOuaAS_Dflau40q_TWHY08k");
  client.ytdl = ytdl;
}
...
module.exports = {
    TOKEN: 'NzkwNTY4Mjg4ODQ4ODM4NjU3.X-CgGA.K8LxTyjutl8CAUuc-mZxqOJvvEA',    
...
client.login('NzkwNTY4Mjg4ODQ4ODM4NjU3.X-CgGA.K8LxTyjutl8CAUuc-mZxqOJvvEA');
