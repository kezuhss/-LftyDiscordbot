...
let config = JSON.parse(fs.readFileSync("./settings.json", "utf8")); //Config file
...
//  Collecting info about command
  ...
  search(args.join(" "), function(err, res) {
    ...
    const filter = m =>
      !isNaN(m.content) && m.content <= videos.length && m.content > 0;
...
exports.help = {
  ...
  description: "Searches the web for the song title",
  usage: "search"
};
